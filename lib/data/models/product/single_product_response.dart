class SingleProductResponse {
  ...
  Product? _product;
  SingleProductResponse copyWith({  Product? product,
  }) => SingleProductResponse(  product: product ?? _product,
  );
...
class ValueI {
  ...
  String? _order;
  String? _value;
  ValueI copyWith({  String? extra,
    String? name,
    String? order,
    String? value,
  }) => Value(  extra: extra ?? _extra,
    name: name ?? _name,
    order: order ?? _order,
    value: value ?? _value,
  );
