class ProductResponseBySlug {
  ProductResponseBySlug({
      String? count, 
  ...
  ProductResponseBySlug.fromJson(dynamic json) {
    _count = json['count'];
...
ProductResponseBySlug copyWith({  String? count,
  List<Products>? products,
}) => ProductResponseBySlug(  count: count ?? _count,
